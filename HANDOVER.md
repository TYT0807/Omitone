...
| 你动了什么 | 必须跑什么 | 判据 |
| --- | --- | --- |
| 任何东西 | `npm test` | **全绿**（自检 12 项 + 提示词基准 + 集成 52 项） |
| 答题链路 / 抠题 / 媒体 / 任务点调度 / `content.js` | `npm run e2e` | **185 / 185**（约 1~2 分钟，会起一个独立 Edge 临时 profile，不碰你正在用的浏览器） |
...
| 测试基线 | 自检 12 项 · 集成 52 项 · 真实 Edge 端到端 **185 项** · 提示词基准 1 份报告，**全绿** |
...
npm run e2e                   # 约 1~2 分钟：起一个独立 Edge 临时 profile，185 项交叉检验
```
