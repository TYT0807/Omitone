...
#### ✅ 最新快照（2026-09-21 深夜）—— 1.2.1 已发布并核验

**当前版本 1.2.1**：1.2.0 之后按域做了一轮代码审计，修了三处问题
...
发版前审查（`npm run audit:publish`）通过、`npm test` 与 `npm run e2e`（26 场景 / 280 项）全绿。
...
| 测试 | 自检 **15** 项（当时还没加第 16 项）· 集成 77 项 · e2e **26 场景 / 280 项** |
