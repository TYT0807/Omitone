...
**4. 用途请自重：仅供学习与技术研究交流，请遵守你所在学校和平台的规章制度。**

本工具的立场一直是"把重复劳动交出去，把时间还给人"。
它不会代替你输入账号密码，也不会代替你发布任何内容（见 §13 边界）。
若用于违反校纪校规或平台协议的用途，后果自负，与本项目无关。
...
这个项目**最初来自哔哩哔哩的一位 UP 主**，不是我从零写起的。

后来这位 UP 主的视频已经下架、网站也不再更新，工具在学习通改版后逐渐不能用了。
我是在这个基础上**继续维护起来的** —— 修 bug、补功能、重做题库适配、加按键安全说明。

> **如果你知道这位 UP 主的 ID、昵称或原视频/仓库链接，欢迎提 issue 告诉我，
> 我会第一时间把署名和原始出处补上。**
> 这份致谢不该是一句含糊的"来自某 UP 主"，我应该给出准确出处。
